...
from models import efficient_capsnet_graph_mnist, efficient_capsnet_graph_smallnorb, efficient_capsnet_graph_multimnist, original_capsnet_graph_mnist, efficient_capsnet_graph_term_project
import os
import json
...
class EfficientCapsNet(Model):
    ...
    def load_graph(self):
        if self.model_name == 'MNIST':
            ...
            self.model = efficient_capsnet_graph_term_project.build_graph(self.config['TERM_PROJECT_INPUT_SHAPE'], self.mode, self.verbose)
